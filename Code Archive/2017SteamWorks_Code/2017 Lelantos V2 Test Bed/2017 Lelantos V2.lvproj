		...
		<Item Name="Sim Support Files" Type="Folder">
			<Item Name="FRC SimulatedRSC" Type="Folder">
				<Item Name="ive" Type="Folder">
					<Item Name="4in Perf Wheel.ive" Type="Document" URL="../../LabVIEW Data/2017 Alpha Lelantos Project/FRC SimulatedRSC/ive/4in Perf Wheel.ive"/>
					<Item Name="AXIS M1011.ive" Type="Document" URL="../../LabVIEW Data/2017 Alpha Lelantos Project/FRC SimulatedRSC/ive/AXIS M1011.ive"/>
					<Item Name="Devantech SRF05.ive" Type="Document" URL="../../LabVIEW Data/2017 Alpha Lelantos Project/FRC SimulatedRSC/ive/Devantech SRF05.ive"/>
					<Item Name="FRC - Body.ive" Type="Document" URL="../../LabVIEW Data/2017 Alpha Lelantos Project/FRC SimulatedRSC/ive/FRC - Body.ive"/>
					<Item Name="Honeywell HMC6343.ive" Type="Document" URL="../../LabVIEW Data/2017 Alpha Lelantos Project/FRC SimulatedRSC/ive/Honeywell HMC6343.ive"/>
					<Item Name="Sparkfun Atomic IMU.ive" Type="Document" URL="../../LabVIEW Data/2017 Alpha Lelantos Project/FRC SimulatedRSC/ive/Sparkfun Atomic IMU.ive"/>
				</Item>
			</Item>
			<Item Name="FRC Simulated.xml" Type="Document" URL="../../LabVIEW Data/2017 Alpha Lelantos Project/FRC Simulated.xml"/>
		</Item>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Team Code" Type="Folder">
			<Item Name="Auto Gear Align.vi" Type="VI" URL="../Auto Gear Align.vi"/>
			<Item Name="Auto Move Straight.vi" Type="VI" URL="../Auto Move Straight.vi"/>
			<Item Name="Auto Turn Precise.vi" Type="VI" URL="../Auto Turn Precise.vi"/>
			<Item Name="Autonomous Independent.vi" Type="VI" URL="../Autonomous Independent.vi"/>
			<Item Name="Begin.vi" Type="VI" URL="../Begin.vi"/>
			<Item Name="BrakeDelay.vi" Type="VI" URL="../BrakeDelay.vi"/>
			<Item Name="Disabled.vi" Type="VI" URL="../Disabled.vi"/>
			<Item Name="Double_GeneralGearShift_WithDeadTime.vi" Type="VI" URL="../Double_GeneralGearShift_WithDeadTime.vi"/>
			<Item Name="Drive_AutoShift.vi" Type="VI" URL="../Drive_AutoShift.vi"/>
			<Item Name="GyroErrorCompensation.vi" Type="VI" URL="../GyroErrorCompensation.vi"/>
			<Item Name="Find Particle.vi" Type="VI" URL="../Find Particle.vi"/>
			<Item Name="Finish.vi" Type="VI" URL="../Finish.vi"/>
			<Item Name="Image Tester.vi" Type="VI" URL="../Image Tester.vi"/>
			<Item Name="Climb Ramp.vi" Type="VI" URL="../Climb Ramp.vi"/>
			<Item Name="Old - Drive Relative.vi" Type="VI" URL="../Old - Drive Relative.vi"/>
			<Item Name="Old - Gear Line Up.vi" Type="VI" URL="../Old - Gear Line Up.vi"/>
			<Item Name="Old - Move Straight.vi" Type="VI" URL="../Old - Move Straight.vi"/>
			<Item Name="Old - Turn Precise.vi" Type="VI" URL="../Old - Turn Precise.vi"/>
			<Item Name="Find Related Particle.vi" Type="VI" URL="../Find Related Particle.vi"/>
			<Item Name="OpenTalonDrive.vi" Type="VI" URL="../OpenTalonDrive.vi"/>
			<Item Name="Paint Bounding Box.vi" Type="VI" URL="../Paint Bounding Box.vi"/>
			<Item Name="Periodic Tasks.vi" Type="VI" URL="../Periodic Tasks.vi"/>
			<Item Name="PID Straight.vi" Type="VI" URL="../PID Straight.vi"/>
			<Item Name="PID Turn.vi" Type="VI" URL="../PID Turn.vi"/>
			<Item Name="PID Veering.vi" Type="VI" URL="../PID Veering.vi"/>
			<Item Name="Pulse.vi" Type="VI" URL="../Pulse.vi"/>
			<Item Name="Robot Global Data.vi" Type="VI" URL="../Robot Global Data.vi"/>
			<Item Name="Sensitivity.vi" Type="VI" URL="../Sensitivity.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../Teleop.vi"/>
			<Item Name="Time Delay.vi" Type="VI" URL="../Time Delay.vi"/>
			<Item Name="Test.vi" Type="VI" URL="../Test.vi"/>
			<Item Name="Toggle.vi" Type="VI" URL="../Toggle.vi"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../Vision Processing.vi"/>
			<Item Name="Write Shift Status.vi" Type="VI" URL="../Write Shift Status.vi"/>
			<Item Name="MappingFunc(XYIntercept).vi" Type="VI" URL="../MappingFunc(XYIntercept).vi"/>
			<Item Name="Joystick Driver Controls.vi" Type="VI" URL="../Joystick Driver Controls.vi"/>
			<Item Name="Leds.vi" Type="VI" URL="../Leds.vi"/>
			<Item Name="Random Boolean 2.0.vi" Type="VI" URL="../Random Boolean 2.0.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Bld_localDestDir" Type="Path">../2017 Lelantos V2 Build</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{A0A0D0E2-4CDD-4DA9-95DB-B490AF86AB31}</Property>
