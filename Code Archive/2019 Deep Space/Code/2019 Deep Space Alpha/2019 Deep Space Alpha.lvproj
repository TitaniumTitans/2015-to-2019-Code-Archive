...
AddOutputFilter chunkFilter
		...
		<Item Name="Open Drive Motors.vi" Type="VI" URL="../Open Drive Motors.vi"/>
		<Item Name="Open Pneumatics.vi" Type="VI" URL="../Open Pneumatics.vi"/>
		<Item Name="Open Utility Motors.vi" Type="VI" URL="../Open Utility Motors.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="AutoClimbNavX.vi" Type="VI" URL="../../2019 Deep Space Alpha 2.0/AutoClimbNavX.vi"/>
			<Item Name="AutoHome.vi" Type="VI" URL="../../Test Code/AutoHome.vi"/>
			<Item Name="DangerZone(ElevatorWrist).vi" Type="VI" URL="../DangerZone(ElevatorWrist).vi"/>
			<Item Name="DangerZone(ElevatorWrist)NoCargo.vi" Type="VI" URL="../../2019 Deep Space Alpha 2.0/DangerZone(ElevatorWrist)NoCargo.vi"/>
			<Item Name="DecodeConsole.vi" Type="VI" URL="../../Test Code/DecodeConsole.vi"/>
			<Item Name="ElevatorBrake.vi" Type="VI" URL="../../2019 Deep Space Alpha 2.0/ElevatorBrake.vi"/>
			<Item Name="FRC_NetworkCommunication.dll" Type="Document" URL="FRC_NetworkCommunication.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="HorseMantain.vi" Type="VI" URL="../HorseMantain.vi"/>
			<Item Name="HorseMantain.vi" Type="VI" URL="../../2019 Deep Space Alpha 2.0/HorseMantain.vi"/>
			<Item Name="Joystick Toggle.vi" Type="VI" URL="../../2019 Deep Space Alpha 2.0/Joystick Toggle.vi"/>
			<Item Name="Limits(DoubleEncoder).vi" Type="VI" URL="../../Toolbox/Simple Limit Switch/Limits(DoubleEncoder).vi"/>
			<Item Name="Limits(DoubleSwitch).vi" Type="VI" URL="../../Toolbox/Simple Limit Switch/Limits(DoubleSwitch).vi"/>
			<Item Name="Limits(SingleSwitch).vi" Type="VI" URL="../../Toolbox/Simple Limit Switch/Limits(SingleSwitch).vi"/>
			<Item Name="Limits(Switch+Encoder).vi" Type="VI" URL="../../Toolbox/Simple Limit Switch/Limits(Switch+Encoder).vi"/>
			...
			<Item Name="PIDSetpointSet.vi" Type="VI" URL="../../2019 Deep Space Alpha 2.0/PIDSetpointSet.vi"/>
			<Item Name="PIDSetpointSet.vi" Type="VI" URL="../../Test Code/PIDSetpointSet.vi"/>
			<Item Name="Power.vi" Type="VI" URL="../../Toolbox/Standalone VI&apos;s/Power.vi"/>
			<Item Name="Pulse.vi" Type="VI" URL="../../Toolbox/Standalone VI&apos;s/Pulse.vi"/>
			<Item Name="SimpleLimitSwitch.vi" Type="VI" URL="../../Toolbox/Simple Limit Switch/SimpleLimitSwitch.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../Teleop.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../../2019 Deep Space Alpha 2.0/Teleop.vi"/>
			<Item Name="TempSetpointSetup.vi" Type="VI" URL="../../Test Code/TempSetpointSetup.vi"/>
			<Item Name="Toggle.vi" Type="VI" URL="../../Toolbox/Standalone VI&apos;s/Toggle.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
