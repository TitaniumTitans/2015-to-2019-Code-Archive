...
AddOutputFilter chunkFilter
		...
		<Item Name="Line Follow.vi" Type="VI" URL="../Line Follow.vi"/>
		<Item Name="MoveElevatorEncoder.vi" Type="VI" URL="../MoveElevatorEncoder.vi"/>
		<Item Name="Open Spark Drive.vi" Type="VI" URL="../Open Spark Drive.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="DangerZone(ElevatorWrist).vi" Type="VI" URL="../../2019 Deep Space Beta 2.0/DangerZone(ElevatorWrist).vi"/>
			<Item Name="DecodeConsole.vi" Type="VI" URL="../../Test Code/DecodeConsole.vi"/>
			<Item Name="FRC_NetworkCommunication.dll" Type="Document" URL="FRC_NetworkCommunication.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="HorseMantain.vi" Type="VI" URL="../../2019 Deep Space Beta 2.0/HorseMantain.vi"/>
			<Item Name="Limits(DoubleEncoder).vi" Type="VI" URL="../../Test Code/SimpleLimitSwitch/Limits(DoubleEncoder).vi"/>
			<Item Name="Limits(DoubleSwitch).vi" Type="VI" URL="../../Test Code/SimpleLimitSwitch/Limits(DoubleSwitch).vi"/>
			<Item Name="Limits(SingleSwitch).vi" Type="VI" URL="../../Test Code/SimpleLimitSwitch/Limits(SingleSwitch).vi"/>
			<Item Name="Limits(Switch+Encoder).vi" Type="VI" URL="../../Test Code/SimpleLimitSwitch/Limits(Switch+Encoder).vi"/>
			...
			<Item Name="Pulse.vi" Type="VI" URL="../../Toolbox/Base VI&apos;s/Pulse.vi"/>
			<Item Name="SimpleLimitSwitch.vi" Type="VI" URL="../../Test Code/SimpleLimitSwitch/SimpleLimitSwitch.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../../2019 Deep Space Beta 2.0/Teleop.vi"/>
			...
			<Item Name="Vision subvi.vi" Type="VI" URL="../../Test Code/Edge Detector/Edge Detector Line/Vision subvi.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Bld_localDestDir" Type="Path">/C/Users/obsid/Google Drive/2019 Deep Space/Code/2019 Deep Space Beta/Builds</Property>
